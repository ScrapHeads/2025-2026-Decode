...
/**
 * Represents a translation in 3D space. This object can be used to represent a
 * point or a vector.
 *
 * <p>
 * This assumes that you are using conventional mathematical axes. When the
 * robot is at the
 * origin facing in the positive X direction, forward is positive X, left is
 * positive Y, and up is
 * positive Z.
 */
public class Translation3d implements Interpolatable<Translation3d> {
    ...
    /**
     * Calculates the squared distance between two translations in 3D space. This is
     * equivalent to
     * squaring the result of {@link #getDistance(Translation3d)}, but avoids
     ...
     *
     * <p>
     * For example, rotating a Translation3d of &lt;2, 0, 0&gt; by 90 degrees around
     * the Z axis
     ...
     * X-Y plane.
     *
     * @return A Translation2d representing this Translation3d projected into the
     *         X-Y plane.
     */
