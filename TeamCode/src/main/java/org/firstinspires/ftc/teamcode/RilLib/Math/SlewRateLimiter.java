...
package org.firstinspires.ftc.teamcode.RilLib;
 ...
 * org.firstinspires.ftc.teamcode.RilLib.Control.TrapezoidProfile} instead.
 */
public class SlewRateLimiter {
     ...
     * @param currentTime       The timestamp of the robot on creation of this object
     */
    public SlewRateLimiter(double positiveRateLimit, double negativeRateLimit, double initialValue, double currentTime) {
     ...
     * @param currentTime The timestamp of the robot on creation of this object
     */
    public SlewRateLimiter(double rateLimit, double currentTime) {
        this(rateLimit, -rateLimit, 0, currentTime);
    }
     ...
     * @param currentTime The timestamp of the robot on creation of this object
     */
    public void reset(double value, double currentTime) {
        m_prevVal = value;
        m_prevTime = currentTime;
    }
}