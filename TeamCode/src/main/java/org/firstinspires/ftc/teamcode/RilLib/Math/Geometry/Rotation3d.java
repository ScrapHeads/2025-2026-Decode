...
public class Rotation3d implements Interpolatable<Rotation3d> {
     ...
     *
     * <p>
     * Angles are measured counterclockwise with the rotation axis pointing "out of
     * the page". If
     * you point your right thumb along the positive axis direction, your fingers
     * curl in the
     * direction of positive rotation.
     *
     * @param roll  The counterclockwise rotation angle around the X axis (roll) in
     *              radians.
     * @param pitch The counterclockwise rotation angle around the Y axis (pitch) in
     *              radians.
     * @param yaw   The counterclockwise rotation angle around the Z axis (yaw) in
     *              radians.
     */
     ...
     * representation is
     * equivalent to axis-angle, where the normalized axis is multiplied by the
     * rotation around the
     * axis in radians.
     *
    ...
    /**
     * Adds the new rotation to the current rotation. The other rotation is applied
     * extrinsically,
     ...
     * Units.degreesToRadians(45), 0))} rotates by 90 degrees around the +X axis and
     * then by 45
    ...
    /**
     * Returns the counterclockwise rotation angle around the X axis (roll) in
     * radians.
     *
     * @return The counterclockwise rotation angle around the X axis (roll) in
     *         radians.
     */
    public double getX() {
    ...
    /**
     * Returns the counterclockwise rotation angle around the Y axis (pitch) in
     * radians.
     *
     * @return The counterclockwise rotation angle around the Y axis (pitch) in
     *         radians.
     */
    public double getY() {
        final var w = m_q.getW();
    ...
    /**
     * Returns the counterclockwise rotation angle around the Z axis (yaw) in
     * radians.
     *
     * @return The counterclockwise rotation angle around the Z axis (yaw) in
     *         radians.
     */
    public double getZ() {
        final var w = m_q.getW();
    ...
    public Vector<N3> getAxis() {
        double norm = Math.sqrt(m_q.getX() * m_q.getX() + m_q.getY() * m_q.getY() + m_q.getZ() * m_q.getZ());
        if (norm == 0.0) {
    ...
    /**
     * Returns the angle in radians in the axis-angle representation of this
     * rotation.
     *
     * @return The angle in radians in the axis-angle representation of this
     *         rotation.
     */
     ...
     * plane.
     *
     * @return A Rotation2d representing this Rotation3d projected into the X-Y
     *         plane.
     */
