...
import org.firstinspires.ftc.teamcode.RilLib.Math.Util.MatrixUtil;
...
public class Matrix<R extends Num, C extends Num> {
   ...
   public final <R2 extends Num, C2 extends Num> Matrix<C, C2> solveFullPivHouseholderQr(
     ...
     MatrixUtil.solveFullPivHouseholderQr(
         this.getData(),
         this.getNumRows(),
         this.getNumCols(),
         other.getData(),
   ...
   public void rankUpdate(Matrix<R, N1> v, double sigma, boolean lowerTriangular) {
     MatrixUtil.rankUpdate(this.getData(), this.getNumRows(), v.getData(), sigma, lowerTriangular);
   }
   ...
   public boolean equals(Object other) {
       if (other == this) {
           ...
           return !MatrixFeatures_DDRM.hasUncountable(matrix.m_storage.getDDRM())
