...
//                .whenActive(new RunBothIntakes(intakeLeft, IntakeLeft.INTAKE_POWER))
...
//                .whenPressed(new RunBothIntakes(intakeLeft, IntakeLeft.INTAKE_POWER));
//
//        driver.getGamepadButton(B)
//                .whenPressed(new RunBothIntakes(intakeLeft, 0));
//
...
//                .whenHeld(new RunBothIntakes(intakeLeft, 0));
//
