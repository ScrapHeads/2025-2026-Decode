...
public class LaunchSequenceLeftAuto extends SequentialCommandGroup {

    public LaunchSequenceLeftAuto(FeederServo feederServo, FeederMotor feederMotor, BallStoppers ballStoppers,
